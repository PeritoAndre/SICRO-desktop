/**
 * SummaryTab — top-level identification block of the ocorrência.
 * Pulls from `DossieSummary` (occurrence + latest_import + counts).
 */
    ...
    <div className={shared.tab}>
      <section className={shared.card}>
        <header className={shared.cardHeader}>
          <h2 className={shared.cardTitle}>Identificação da ocorrência</h2>
        </header>
        <dl className={shared.metaGrid}>
          <Row label="BO" value={o.numero_bo} />
          <Row label="Requisição / Ofício" value={o.requisicao ?? o.oficio} />
          <Row label="Protocolo" value={o.protocolo} />
          <Row label="Unidade policial" value={o.delegacia} />
          <Row label="Tipo de perícia" value={o.tipo_pericia} />
          <Row label="Natureza" value={o.natureza} />
          <Row label="Resultado" value={o.resultado ?? null} />
          <Row label="Status" value={o.status} mono />
        </dl>
      </section>

      <section className={shared.card}>
        <header className={shared.cardHeader}>
          <h2 className={shared.cardTitle}>Local</h2>
        </header>
        <dl className={shared.metaGrid}>
          <Row label="Município" value={o.municipio} />
          <Row label="Bairro" value={o.bairro} />
          <Row label="Logradouro" value={o.logradouro} />
          <Row label="Referência" value={o.referencia} />
          <Row
            label="Coordenada"
            icon={<MapPin size={12} />}
            value={
          ...
          <Row
            label="Precisão GPS"
            value={o.primary_accuracy_m != null ? `±${o.primary_accuracy_m} m` : null}
          />
        </dl>
      </section>
