      ...
      >
        ...
        >
          <strong style={{ color: "#7c3aed" }}>
            Importação OSM — Python Parity Engine
          </strong>{" "}
          — O mapa acima é apenas referência geográfica. As vias
          importadas serão geradas como objetos do Python Parity Engine
          (Bezier 4 pontos + rotatórias dedicadas) — o mesmo motor
          aprovado visualmente em H.3. Editáveis depois.
        </div>
        <div
          style={{
            display: "flex",
